...
const MissionValues = () => {
  ...
  return (
    <div className="py-20 px-8 bg-[#79B3AF]">
      <h2 className="text-4xl font-bold text-center text-white  mb-12">Our Mission and Values</h2>
      <div className="flex justify-around md:m-5 space-x-2 my-4">
      ...
      <div className="flex justify-around md:m-5 space-x-2 my-5">
